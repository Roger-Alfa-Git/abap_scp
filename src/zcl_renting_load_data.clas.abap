...
CLASS zcl_renting_load_data IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    ...
    DATA: lt_brands    TYPE TABLE OF zrent_brands_a10,
          lt_cars      TYPE TABLE OF zrent_cars_a10,
...
** BRANDS **
    ...
    DELETE FROM zrent_brands_a10.
    INSERT zrent_brands_a10 FROM TABLE @lt_brands.
    SELECT * FROM zrent_brands_a10 INTO TABLE
    @lt_brands.
    out->write( sy-dbcnt ).
...
** CARS**
    ...
    DELETE FROM zrent_cars_a10.
    INSERT zrent_cars_a10 FROM TABLE @lt_cars.
    SELECT * FROM zrent_cars_a10 INTO TABLE @lt_cars.
    out->write( sy-dbcnt ).
