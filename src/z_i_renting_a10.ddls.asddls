...
define view z_i_renting_a10
  as select from z_b_cars_a10 as Cars
  association [1]    to z_b_rem_days         as _RemDays     on Cars.Matricula = _RemDays.Matericula
  association [0..*] to z_b_brands           as _Brands      on Cars.Marca = _Brands.Marca
  association [0..*] to z_b_det_customer_a10 as _DetCustomer on Cars.Matricula = _DetCustomer.Matricula
{
  key Matricula,
      Marca,
      Modelo,
